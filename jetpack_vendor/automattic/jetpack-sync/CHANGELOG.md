...
## [1.35.1-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Added
- Add a request lock to prevent multiple requests being spawned at once
...
[1.35.1-alpha]: https://github.com/Automattic/jetpack-sync/compare/v1.35.0...v1.35.1-alpha
