...
### Added
- Add a `jetpack_site_visibility` callable that reports -1 when the `jetpack_is_private_site` filter marks the site private, without changing the `blog_public` option.
...
[5.2.0-alpha]: https://github.com/Automattic/jetpack-sync/compare/v5.1.3...v5.2.0-alpha
