...
### Added
- Newsletters: Add option to enable subscribe modal.
- Sync: Add support for additional guest and note meta fields
...
[1.51.0-alpha]: https://github.com/Automattic/jetpack-sync/compare/v1.50.2...v1.51.0-alpha
