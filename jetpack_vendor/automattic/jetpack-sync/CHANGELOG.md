...
## [1.38.1-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Changed
- Search Sync Settings :: Add Marketplace related meta fields and taxonomies to allow list
...
[1.38.1-alpha]: https://github.com/Automattic/jetpack-sync/compare/v1.38.0...v1.38.1-alpha
