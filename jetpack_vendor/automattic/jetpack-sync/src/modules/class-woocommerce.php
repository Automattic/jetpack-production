...
class WooCommerce extends Module {
	 ...
	 *
	 * @since 4.44.0-alpha Appends a trailing [ 'total', 'currency' ] payload when the new order is paid.
	 *
	 ...
	 * other purposes).
	 *
	 * @since 4.44.0-alpha Appends a trailing [ 'total', 'currency' ] payload on the paid transition.
	 *
