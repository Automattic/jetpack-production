<?php
/**
 * WooCommerce Analytics sync module.
 *
 * Syncs the data behind WooCommerce Analytics reports (wc_order_stats and the
 * order product/coupon/tax lookup tables) to WordPress.com.
 *
