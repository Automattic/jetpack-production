...
class Admin_Menu {
	 ...
	 * hook still works.
	 *
	 * @deprecated 0.10.0-alpha Use hide_core_admin_notices(), which enqueues the CSS.
	 *
	 * @return void
	 */
	public static function print_hide_core_admin_notices_style() {
		_deprecated_function( __METHOD__, 'admin-ui-0.10.0-alpha', __CLASS__ . '::hide_core_admin_notices' );
