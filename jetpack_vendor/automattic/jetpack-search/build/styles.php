 ...
 *
 * Note: These styles can be overridden by calling jetpack_search_override_style()
 ...
 */
function jetpack_search_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function jetpack_search_register_package_styles( $styles ) {
...
add_action( 'wp_default_styles', 'jetpack_search_register_package_styles' );
