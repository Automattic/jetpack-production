...
## [0.52.22-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Fixed
- Prevent PHP errors when handling malformed data.
...
[0.52.22-alpha]: https://github.com/Automattic/jetpack-search/compare/v0.52.21...v0.52.22-alpha
