...
var require_with_selector_development = __commonJS({
  "../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React67 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef32 = React67.useRef, useEffect22 = React67.useEffect, useMemo27 = React67.useMemo, useDebugValue2 = React67.useDebugValue;
...
function useStoreR19(store3, selector, a1, a2, a3) {
  const getSelection = React28.useCallback(() => selector(store3.getSnapshot(), a1, a2, a3), [store3, selector, a1, a2, a3]);
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(React42.Fragment, {
...
var CSPContext = /* @__PURE__ */ React43.createContext(void 0);
if (true) CSPContext.displayName = "CSPContext";
var DEFAULT_CSP_CONTEXT_VALUE = {
  disableStyleElements: false
};
function useCSPContext() {
  return React43.useContext(CSPContext) ?? DEFAULT_CSP_CONTEXT_VALUE;
}
...
function useCompositeRoot(params) {
  ...
  const [internalHighlightedIndex, internalSetHighlightedIndex] = React44.useState(0);
  const isGrid = cols > 1;
  const rootRef = React44.useRef(null);
  const mergedRef = useMergedRefs(rootRef, externalRef);
  const elementsRef = React44.useRef([]);
  const hasSetDefaultIndexRef = React44.useRef(false);
...
function CompositeRoot(componentProps) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(CompositeRootContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(CompositeList, {
      elementsRef,
      onMapChange: (newMap) => {
...
var FloatingPortalLite = /* @__PURE__ */ React46.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(React46.Fragment, {
...
var TabsRootContext = /* @__PURE__ */ React47.createContext(void 0);
if (true) TabsRootContext.displayName = "TabsRootContext";
function useTabsRootContext() {
  const context = React47.useContext(TabsRootContext);
  if (context === void 0) {
...
var TabsRoot = /* @__PURE__ */ React48.forwardRef(function TabsRoot2(componentProps, forwardedRef) {
  const {
    className,
  ...
  const tabPanelRefs = React48.useRef([]);
  const [mountedTabPanels, setMountedTabPanels] = React48.useState(() => /* @__PURE__ */ new Map());
  ...
  const [tabMap, setTabMap] = React48.useState(() => /* @__PURE__ */ new Map());
  const getTabElementBySelectedValue = React48.useCallback((selectedValue) => {
  ...
  const [activationDirectionState, setActivationDirectionState] = React48.useState(() => ({
    previousValue: value,
  ...
  const getTabPanelIdByValue = React48.useCallback((tabValue) => {
    return mountedTabPanels.get(tabValue);
  }, [mountedTabPanels]);
  const getTabIdByPanelValue = React48.useCallback((tabPanelValue) => {
  ...
  const selectedTabMetadata = React48.useMemo(() => {
    for (const tabMetadata of tabMap.values()) {
  ...
  const firstEnabledTabValue = React48.useMemo(() => {
    for (const tabMetadata of tabMap.values()) {
  ...
  const shouldNotifyInitialValueChangeRef = React48.useRef(!hasExplicitDefaultValueProp);
  const shouldHonorDisabledDefaultValueRef = React48.useRef(hasExplicitDefaultValueProp);
  const didRegisterTabsRef = React48.useRef(false);
  useIsoLayoutEffect(() => {
    if (isControlled) {
      return;
    }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TabsRootContext.Provider, {
...
var TabsListContext = /* @__PURE__ */ React49.createContext(void 0);
if (true) TabsListContext.displayName = "TabsListContext";
function useTabsListContext() {
  const context = React49.useContext(TabsListContext);
  if (context === void 0) {
...
// ../../../node_modules/.pnpm/@base-ui+react@1.5.0_@types+react@18.3.28_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@base-ui/react/esm/tabs/tab/TabsTab.js
var TabsTab = /* @__PURE__ */ React50.forwardRef(function TabsTab2(componentProps, forwardedRef) {
  const {
    className,
    disabled: disabled2 = false,
    render,
  ...
  const isNavigatingRef = React50.useRef(false);
  const tabElementRef = React50.useRef(null);
  React50.useEffect(() => {
  ...
  const isPressingRef = React50.useRef(false);
  const isMainButtonRef = React50.useRef(false);
...
var TabsIndicator = /* @__PURE__ */ React51.forwardRef(function TabsIndicator2(componentProps, forwardedRef) {
  const {
    className,
    render,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(React51.Fragment, {
    children: [element, isHydrating && renderBeforeHydration && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("script", {
      nonce,
...
var TabsPanel = /* @__PURE__ */ React52.forwardRef(function TabsPanel2(componentProps, forwardedRef) {
  const {
    className,
    value,
    render,
  ...
  const panelRef = React52.useRef(null);
  const element = useRenderElement("div", componentProps, {
    state,
...
var TabsList = /* @__PURE__ */ React53.forwardRef(function TabsList2(componentProps, forwardedRef) {
  const {
  ...
  const [highlightedTabIndex, setHighlightedTabIndex] = React53.useState(0);
  const [tabsListElement, setTabsListElement] = React53.useState(null);
  const indicatorUpdateListenersRef = React53.useRef(/* @__PURE__ */ new Set());
  const tabResizeObserverElementsRef = React53.useRef(/* @__PURE__ */ new Set());
  const resizeObserverRef = React53.useRef(null);
  React53.useEffect(() => {
  ...
  const tabsListContextValue = React53.useMemo(() => ({
    activateOnFocus,
    highlightedTabIndex,
    registerIndicatorUpdateListener,
    registerTabResizeObserverElement,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TabsListContext.Provider, {
    value: tabsListContextValue,
    children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(CompositeRoot, {
      render,
      className,
      style,
      state,
...
var TooltipRootContext = /* @__PURE__ */ React54.createContext(void 0);
if (true) TooltipRootContext.displayName = "TooltipRootContext";
function useTooltipRootContext(optional) {
  const context = React54.useContext(TooltipRootContext);
  if (context === void 0 && !optional) {
...
var TooltipProviderContext = /* @__PURE__ */ React57.createContext(void 0);
if (true) TooltipProviderContext.displayName = "TooltipProviderContext";
function useTooltipProviderContext() {
  return React57.useContext(TooltipProviderContext);
}
...
var TooltipPortalContext = /* @__PURE__ */ React59.createContext(void 0);
if (true) TooltipPortalContext.displayName = "TooltipPortalContext";
function useTooltipPortalContext() {
  const value = React59.useContext(TooltipPortalContext);
  if (value === void 0) {
...
var TooltipPortal = /* @__PURE__ */ React60.forwardRef(function TooltipPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TooltipPortalContext.Provider, {
    value: keepMounted,
    children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FloatingPortalLite, {
      ref: forwardedRef,
      ...portalProps
    })
  });
...
var TooltipPositionerContext = /* @__PURE__ */ React61.createContext(void 0);
if (true) TooltipPositionerContext.displayName = "TooltipPositionerContext";
function useTooltipPositionerContext() {
  const context = React61.useContext(TooltipPositionerContext);
  if (context === void 0) {
...
var TooltipPositioner = /* @__PURE__ */ React62.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    anchor,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(TooltipPositionerContext.Provider, {
    value: positioning,
    children: element
  });
});
...
var TooltipPopup = /* @__PURE__ */ React63.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var TooltipArrow = /* @__PURE__ */ React64.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React65.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(TooltipProviderContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(FloatingDelayGroup, {
      delay: delayValue,
      timeoutMs: timeout,
...
var TooltipViewport = /* @__PURE__ */ React66.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DEFAULT_TAG = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", {});
...
var caution_default = /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_primitives2.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(import_primitives2.Path, { fillRule: "evenodd", clipRule: "evenodd", d: "M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-.75 12v-1.5h1.5V16h-1.5Zm0-8v5h1.5V8h-1.5Z" }) });
...
var chevron_right_default = /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_primitives3.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_primitives3.Path, { d: "M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z" }) });
...
var close_small_default = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_primitives4.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_primitives4.Path, { d: "M12 13.06l3.712 3.713 1.061-1.06L13.061 12l3.712-3.712-1.06-1.06L12 10.938 8.288 7.227l-1.061 1.06L10.939 12l-3.712 3.712 1.06 1.061L12 13.061z" }) });
...
var error_default = /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_primitives5.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_primitives5.Path, { fillRule: "evenodd", clipRule: "evenodd", d: "M12.218 5.377a.25.25 0 0 0-.436 0l-7.29 12.96a.25.25 0 0 0 .218.373h14.58a.25.25 0 0 0 .218-.372l-7.29-12.96Zm-1.743-.735c.669-1.19 2.381-1.19 3.05 0l7.29 12.96a1.75 1.75 0 0 1-1.525 2.608H4.71a1.75 1.75 0 0 1-1.525-2.608l7.29-12.96ZM12.75 17.46h-1.5v-1.5h1.5v1.5Zm-1.5-3h1.5v-5h-1.5v5Z" }) });
...
if (typeof process === "undefined" || true) {
  registerStyle7("b51ff41489", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-components{._19ce0419607e1896__stack{display:flex}}");
}
...
var Portal = (0, import_element21.forwardRef)(
  function TooltipPortal3(props, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(index_parts_exports2.Portal, { ref, ...props });
  }
);
...
if (typeof process === "undefined" || true) {
  registerStyle9("8293efbb49", '@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-components{._480b748dd3510e64__positioner{z-index:var(--wp-ui-tooltip-z-index,initial)}._50096b232db7709d__popup{background-color:var(--wpds-color-bg-surface-neutral-strong,#fff);border-radius:var(--wpds-border-radius-sm,2px);box-shadow:var(--wpds-elevation-sm,0 1px 2px 0 #0000000d,0 2px 3px 0 #0000000a,0 6px 6px 0 #00000008,0 8px 8px 0 #00000005);color:var(--wpds-color-fg-content-neutral,#1e1e1e);font-family:var(--wpds-typography-font-family-body,-apple-system,system-ui,"Segoe UI","Roboto","Oxygen-Sans","Ubuntu","Cantarell","Helvetica Neue",sans-serif);font-size:var(--wpds-typography-font-size-sm,12px);line-height:1.4;padding:var(--wpds-dimension-padding-xs,4px) var(--wpds-dimension-padding-sm,8px);@media (forced-colors:active){border-bottom-color:CanvasText;border-bottom-style:solid;border-bottom-width:1px;border-left-color:CanvasText;border-left-style:solid;border-left-width:1px;border-right-color:CanvasText;border-right-style:solid;border-right-width:1px;border-top-color:CanvasText;border-top-style:solid;border-top-width:1px}}}');
}
...
var Popup = (0, import_element23.forwardRef)(function TooltipPopup3({ portal, positioner, children, className, ...props }, ref) {
  const popupContent = (
     ...
     *     below
     */
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(ThemeProvider, { color: { bg: "#1e1e1e" }, children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      index_parts_exports2.Popup,
      {
        ref,
        className: clsx_default(style_default9.popup, className),
        ...props,
        children
      }
    ) })
...
function Provider({ ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(index_parts_exports2.Provider, { ...props });
}
...
if (typeof process === "undefined" || true) {
  registerStyle10("358a2a646a", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-compositions{._28cfdc260e755391__icon-button{--wp-ui-button-aspect-ratio:1;--wp-ui-button-padding-inline:0;--wp-ui-button-min-width:unset}.f1c70d719989a85a__icon{margin:-1px}}");
}
var style_default10 = { "icon-button": "_28cfdc260e755391__icon-button", "icon": "f1c70d719989a85a__icon" };
var IconButton = (0, import_element25.forwardRef)(
  function IconButton2({
    ...
    const classes = clsx_default(style_default10["icon-button"], className);
    return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(Provider, { delay: 0, children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(Root2, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(Popup, { positioner, children: [
        label,
...
function useScheduleValidation(validate) {
  const validateRef = (0, import_element26.useRef)(validate);
  validateRef.current = validate;
  const timerRef = (0, import_element26.useRef)(null);
  const unmountedRef = (0, import_element26.useRef)(false);
  const scheduleValidation = (0, import_element26.useCallback)(() => {
...
function safeRenderToString(message) {
  ...
  try {
    return (0, import_element28.renderToString)(message);
  } catch {
    return void 0;
  }
}
...
var Root3 = (0, import_element28.forwardRef)(function Notice({
  intent = "neutral",
  children,
  icon,
  ...
  const mergedClassName = clsx_default(
    style_default12.notice,
    style_default12[`is-${intent}`],
...
var Title2 = (0, import_element29.forwardRef)(
...
var Description = (0, import_element30.forwardRef)(
...
var Actions = (0, import_element31.forwardRef)(
  function NoticeActions({ render, ...props }, ref) {
    const element = useRender({
      ...
      props: mergeProps(
        {
          className: style_default15.actions
        },
        props
      )
    });
...
var style_default16 = { "notice": "_4145abab73d17514__notice", "icon": "d0a25570cb528528__icon", "title": "b5397fb9d05389e3__title", "description": "_1904b570a89bb815__description", "actions": "_0a1270dcdd79c031__actions", "action-button": "_983740ab855c4e09__action-button", "action-link": "d329e7416d368d31__action-link", "close-icon": "_487e6a5c1375f7dc__close-icon", "is-info": "_531c140826094795__is-info", "is-warning": "ae2e1004697cce95__is-warning", "is-success": "_2e614a76af494837__is-success", "is-error": "af00331ae17a0065__is-error", "is-action-button-outline": "_8ddb8fb33fbf3d38__is-action-button-outline", "is-action-button-minimal": "_77bbde495a8a0af3__is-action-button-minimal" };
var CloseIcon = (0, import_element32.forwardRef)(
  function NoticeCloseIcon({ className, icon = close_small_default, label = (0, import_i18n5.__)("Dismiss"), ...props }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      IconButton,
      {
        ...props,
        ref,
        className: clsx_default(style_default16["close-icon"], className),
        variant: "minimal",
        size: "small",
        tone: "neutral",
        icon,
...
var ActionButton = (0, import_element33.forwardRef)(
  function NoticeActionButton({ className, loading, loadingAnnouncement, variant, ...props }, ref) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
      Button4,
      {
        ...
        variant,
        className: clsx_default(
          style_default17["action-button"],
          style_default17[`is-action-button-${variant}`],
          className
        )
      }
    );
...
var ActionLink = (0, import_element34.forwardRef)(
  function NoticeActionLink({ className, render, ...props }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
      Text,
      {
        ref,
        className: clsx_default(style_default18["action-link"], className),
        ...props,
        variant: "body-md",
        render: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(Link, { tone: "neutral", variant: "default", render })
      }
    );
  }
);
...
var List = (0, import_element35.forwardRef)(
  function TabList({
    children,
    variant = "default",
    className,
    ...
    const [listEl, setListEl] = (0, import_element35.useState)(null);
    const [overflow, setOverflow] = (0, import_element35.useState)({
      first: false,
      last: false,
      isScrolling: false
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(
      index_parts_exports.List,
      {
        ...
        className: clsx_default(
          style_default19.tablist,
          overflow.first && style_default19["is-overflowing-first"],
          overflow.last && style_default19["is-overflowing-last"],
          style_default19[`is-${variant}-variant`],
          className
        ),
        ...otherProps,
        ...
        children: [
          children,
          /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(index_parts_exports.Indicator, { className: style_default19.indicator })
        ]
      }
    );
  }
...
var TabsValidationContext = VALIDATION_ENABLED ? (0, import_element36.createContext)(null) : null;
function useRegisterTabDev() {
  const context = (0, import_element36.useContext)(TabsValidationContext);
...
function TabsValidationProviderDev({
  ...
  const tabCountRef = (0, import_element36.useRef)(0);
  const panelCountRef = (0, import_element36.useRef)(0);
  ...
  const registerTab = (0, import_element36.useCallback)(() => {
  ...
  const registerPanel = (0, import_element36.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(TabsValidationContext.Provider, { value: contextValue, children });
}
...
if (typeof process === "undefined" || true) {
  registerStyle20("2a5ab8f3a7", "@layer wp-ui-utilities, wp-ui-components, wp-ui-compositions, wp-ui-overrides;@layer wp-ui-utilities{._08e8a2e44959f892__outset-ring--focus,._970d04df7376df67__outset-ring--focus-within-except-active,.c5cb3ee4bddaa8e4__outset-ring--focus-within-visible,.cd83dfc2126a0846__outset-ring--focus-within,.d0541bc9dd9dc7b6__outset-ring--focus-visible,.e25b2bdd7aa21721__outset-ring--focus-except-active,.ecadb9e080e2dfa5__outset-ring--focus-parent-visible{@media not (prefers-reduced-motion){--_gcd-a-transition:outline 0.1s ease-out;transition:outline .1s ease-out}outline:0 solid #0000;outline-offset:1px}._08e8a2e44959f892__outset-ring--focus:focus,._970d04df7376df67__outset-ring--focus-within-except-active:focus-within:not(:has(:active)),.c5cb3ee4bddaa8e4__outset-ring--focus-within-visible:focus-within:has(:focus-visible),.cd83dfc2126a0846__outset-ring--focus-within:focus-within,.d0541bc9dd9dc7b6__outset-ring--focus-visible:focus-visible,.e25b2bdd7aa21721__outset-ring--focus-except-active:focus:not(:active),:focus-visible .ecadb9e080e2dfa5__outset-ring--focus-parent-visible{--_gcd-a-outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--wpds-color-stroke-focus-brand,var(--wp-admin-theme-color,#3858e9));--_gcd-div-outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--wpds-color-stroke-focus-brand,var(--wp-admin-theme-color,#3858e9));outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--wpds-color-stroke-focus-brand,var(--wp-admin-theme-color,#3858e9))}}");
}
...
var Panel = (0, import_element37.forwardRef)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
      index_parts_exports.Panel,
      {
        ...
        className: clsx_default(
          ...
          focus_default3["outset-ring--focus-visible"],
          className
        ),
        ...otherProps
      }
...
var Root4 = (0, import_element38.forwardRef)(
  function TabsRoot3({ ...otherProps }, forwardedRef) {
    return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(TabsValidationProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(index_parts_exports.Root, { ref: forwardedRef, ...otherProps }) });
  }
);
...
var Tab = (0, import_element39.forwardRef)(function Tab2({ className, children, ...otherProps }, forwardedRef) {
  useRegisterTab();
  return /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)(
    index_parts_exports.Tab,
    {
      ref: forwardedRef,
      className: clsx_default(style_default20.tab, className),
      ...otherProps,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)("span", { className: style_default20["tab-children"], children }),
        /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(Icon, { icon: chevron_right_default, className: style_default20["tab-chevron"] })
      ]
    }
  );
});
...
var JetpackFooter = ({ className, menu, ...otherProps }) => {
  ...
  return (0, import_jsx_runtime47.jsxs)(Stack, { render: (0, import_jsx_runtime47.jsx)("footer", {}), className: clsx_default("jetpack-footer", className), "aria-label": (0, import_i18n6.__)("Jetpack", "jetpack-components"), role: "contentinfo", direction: "row", justify: "flex-start", align: "center", wrap: "wrap", gap: "xl", ...otherProps, children: [
    (0, import_jsx_runtime47.jsxs)(Stack, { className: "jetpack-footer__logo", direction: "row", gap: "sm", align: "center", children: [
      (0, import_jsx_runtime47.jsx)(jetpack_logo_default, { showText: false, height: 16, "aria-hidden": "true" }),
      (0, import_jsx_runtime47.jsx)(Text, { variant: "body-md", children: "Jetpack" })
    ] }),
    (0, import_jsx_runtime47.jsx)(Stack, { render: (0, import_jsx_runtime47.jsx)("ul", {}), direction: "row", gap: "lg", wrap: "wrap", children: items.map((item) => {
      return (0, import_jsx_runtime47.jsx)("li", { children: (0, import_jsx_runtime47.jsx)(Text, { variant: "body-md", className: "jetpack-footer__menu-item", render: !item.href ? (0, import_jsx_runtime47.jsx)(Link, { render: (0, import_jsx_runtime47.jsx)("span", {}), tabIndex: 0, title: item.title || "", onClick: item.onClick || void 0, onKeyDown: item.onKeyDown || void 0, role: "button" }) : (0, import_jsx_runtime47.jsx)(Link, { href: item.href, title: item.title || "", onClick: item.onClick || void 0, onKeyDown: item.onKeyDown || void 0 }), children: item.label }) }, item.label);
    }) }),
    (0, import_jsx_runtime47.jsx)("a", { className: "jetpack-footer__a8c", href: getRedirectUrl("a8c-about"), rel: "noopener noreferrer", target: "_blank", children: (0, import_jsx_runtime47.jsx)(automattic_byline_logo_default, { height: 8 }) })
  ] });
};
...
var NavigableRegion = (0, import_element40.forwardRef)(
...
function Header2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(Stack, { direction: "column", className: style_default21.header, children: [
    /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(
      Stack,
      {
        className: style_default21["header-content"],
        direction: "row",
        gap: "sm",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(Stack, { direction: "row", gap: "sm", align: "center", justify: "start", children: [
            showSidebarToggle && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
              SidebarToggleSlot,
              {
                ...
                className: style_default21["sidebar-toggle-slot"]
              }
            ),
            visual && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
              "div",
              {
                className: style_default21["header-visual"],
                "aria-hidden": "true",
                children: visual
              }
            ),
            title && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
              Text,
              {
                className: style_default21["header-title"],
          ...
          actions3 && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
            Stack,
            {
              align: "center",
    ...
    subTitle && /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(
      Text,
      {
        ...
        variant: "body-md",
        className: style_default21["header-subtitle"],
        children: subTitle
      }
    )
  ] });
...
if (typeof process === "undefined" || true) {
  registerStyle24("aa9c241ccc", "._956b6df0898efed0__page{text-wrap:pretty;background-color:var(--wpds-color-bg-surface-neutral,#fcfcfc);color:var(--wpds-color-fg-content-neutral,#1e1e1e);display:flex;flex-flow:column;height:100%;position:relative;z-index:1}._0625b55e82a0d93d__header{background:var(--wpds-color-bg-surface-neutral-strong,#fff);border-block-end:var(--wpds-border-width-xs,1px) solid var(--wpds-color-stroke-surface-neutral-weak,#e4e4e4);inset-block-start:0;padding:var(--wpds-dimension-padding-lg,16px) var(--wpds-dimension-padding-2xl,24px);position:sticky;z-index:1}.a43c44d5ae28b2e8__header-content{min-height:calc(var(--wpds-dimension-base, 4px)*8)}.b7cb5b9daf3a3b25__header-actions{flex-shrink:0}._8113be94e7caf73c__header-title{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}._9a776c7f70996f61__header-visual{display:grid;flex-shrink:0;grid-template-columns:1fr;grid-template-rows:1fr;height:calc(var(--wpds-dimension-base, 4px)*6);width:calc(var(--wpds-dimension-base, 4px)*6);>*{grid-column:1/-1;grid-row:1/-1;max-height:100%;max-width:100%}}.d5e0920cd15d35bc__sidebar-toggle-slot:empty{display:none}._60fea2f6bf5319cd__header-subtitle{color:var(--wpds-color-fg-content-neutral-weak,#707070);padding-block-end:var(--wpds-dimension-padding-xs,4px)}.be5e57d029ec4036__content{display:flex;flex-direction:column;flex-grow:1;overflow:auto;&._128806d0b26e3a50__has-padding{padding:var(--wpds-dimension-padding-lg,16px) var(--wpds-dimension-padding-2xl,24px)}}");
}
...
function Page({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)(navigable_region_default, { className: classes, ariaLabel: effectiveAriaLabel, children: [
    (title || breadcrumbs || badges || actions3 || visual) && /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(
      Header2,
      {
        headingLevel,
        breadcrumbs,
    ...
    hasPadding ? /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(
      ...
      {
        className: clsx_default(
          style_default22.content,
          style_default22["has-padding"]
        ),
        children
      }
    ) : children
...
// ../../js-packages/components/build/components/admin-page/index.js
var AdminPage = ({ children, className, showHeader = true, showFooter = true, showBackground = true, sandboxedDomain = "", apiRoot = "", apiNonce = "", optionalMenuItems, header, title, subTitle, logo, actions: actions3, breadcrumbs, tabs, showBottomBorder = true, unwrapped = false }) => {
  ...
  const testConnection = (0, import_react14.useCallback)(async () => {
    try {
  ...
  if (showHeader && (title || breadcrumbs)) {
    return (0, import_jsx_runtime51.jsx)("div", { className: rootClassName, children: (0, import_jsx_runtime51.jsxs)(page_default, { className: "jp-admin-page__page", visual: logo || (0, import_jsx_runtime51.jsx)(jetpack_logo_default, { showText: false, height: 20 }), breadcrumbs, title, subTitle, actions: actions3, showSidebarToggle: false, children: [tabs, unwrapped ? children : (0, import_jsx_runtime51.jsx)(container_default, { fluid: true, horizontalSpacing: 0, children: (0, import_jsx_runtime51.jsx)(col_default, { children }) }), showFooter && (0, import_jsx_runtime51.jsx)(jetpack_footer_default, { menu: optionalMenuItems })] }) });
  }
  ...
  })] }) }), (0, import_jsx_runtime51.jsx)(container_default, { fluid: true, horizontalSpacing: 0, children: (0, import_jsx_runtime51.jsx)(col_default, { children }) }), showFooter && (0, import_jsx_runtime51.jsx)(jetpack_footer_default, { menu: optionalMenuItems })] });
};
...
if (typeof process === "undefined" || true) {
  registerStyle22("75307ce846", ":where(._59ace9150608bcd8__global) *{box-sizing:border-box}");
}
...
var ThemeProvider2 = ({ children = null, targetDom, id, withGlobalStyles = true }) => {
  const themeWrapperRef = (0, import_react15.useRef)();
  ...
  return (0, import_jsx_runtime52.jsx)("div", { ref: themeWrapperRef, children });
};
...
// _inc/data/settings-store.ts
var import_data2 = __toESM(require_data());
var STORE_NAME2 = "jetpack-seo/settings";
var DEFAULT_STATE2 = {
  settings: getScriptData()?.seo?.settings ?? null
};
var actions2 = {
  /**
...
var store2 = (0, import_data2.createReduxStore)(STORE_NAME2, {
  reducer(state = DEFAULT_STATE2, action) {
...
(0, import_data2.register)(store2);
...
function useSeoToolsToggle() {
  ...
  const { createErrorNotice } = (0, import_data3.useDispatch)(import_notices.store);
...
var SiteVisibilityCard = ({ data, onManage }) => {
  const sitemapActive = data.sitemap_active && data.search_engines_visible;
  return /* @__PURE__ */ (0, import_jsx_runtime61.jsxs)(card_exports.Root, { children: [
...
var OverviewScreen = () => {
  ...
  const coverage = (0, import_data4.useSelect)((select) => select(store).getCoverage(), []);
  const settings = (0, import_data4.useSelect)((select) => select(store2).getSettings(), []);
      ...
      /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(
        site_visibility_card_default,
        {
          data: {
            ...
            search_engines_visible: settings?.search_engines_visible ?? data.site_visibility.search_engines_visible,
