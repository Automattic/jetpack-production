...
### Fixed
- Return uncached connection errors for Stats requests with missing or rejected blog tokens so requests recover when the connection is restored.
...
[0.21.1-alpha]: https://github.com/Automattic/jetpack-stats/compare/v0.21.0...v0.21.1-alpha
