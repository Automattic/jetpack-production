...
if ( ! function_exists( 'gutenberg_register_jetpack_forms_responses_page_routes' ) ) {
	/**
	 * Register routes for jetpack-forms-responses page (full-page mode).
	 */
	function gutenberg_register_jetpack_forms_responses_page_routes() {
		global $gutenberg_jetpack_forms_responses_routes_data;
		gutenberg_register_page_routes( $gutenberg_jetpack_forms_responses_routes_data, 'gutenberg_register_jetpack_forms_responses_route' );
	}
}
add_action( 'jetpack-forms-responses_init', 'gutenberg_register_jetpack_forms_responses_page_routes' );

if ( ! function_exists( 'gutenberg_register_jetpack_forms_responses_wp_admin_page_routes' ) ) {
	/**
	 * Register routes for jetpack-forms-responses page (wp-admin mode).
	 */
	function gutenberg_register_jetpack_forms_responses_wp_admin_page_routes() {
		global $gutenberg_jetpack_forms_responses_routes_data;
		gutenberg_register_page_routes( $gutenberg_jetpack_forms_responses_routes_data, 'gutenberg_register_jetpack_forms_responses_wp_admin_route' );
	}
}
add_action( 'jetpack-forms-responses-wp-admin_init', 'gutenberg_register_jetpack_forms_responses_wp_admin_page_routes' );
