...
class Contact_Form_Plugin {
	...
	public function get_export_data_for_posts( $post_ids ) {
		_deprecated_function( __METHOD__, 'package-5.1.0-alpha', 'Contact_Form_Plugin::get_export_feedback_data()' );
	...
	public function get_well_known_column_names() {
		_deprecated_function( __METHOD__, 'package-5.1.0-alpha', 'Contact_Form_Plugin::get_export_column_names()' );
		return array(
