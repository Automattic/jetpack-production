...
class Contact_Form extends Contact_Form_Shortcode {
	 ...
	 *
	 * @deprecated 5.0.0-alpha
	 */
	public static function store_shortcode() {
		_deprecated_function( __METHOD__, '5.0.0-alpha', 'Contact_Form_Plugin::store_shortcode()' );
	}
	...
	public static function get_compiled_form( $feedback_id, $form = null ) {
		if ( $form ) {
			...
			_deprecated_argument( __METHOD__, '5.0.0-alpha', 'The $form parameter is deprecated and no longer used.' );
		}
