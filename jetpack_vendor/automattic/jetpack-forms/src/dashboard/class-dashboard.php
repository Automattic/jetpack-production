...
class Dashboard {
	 ...
	 *
	 * @var string
	 * @deprecated 8.1.0-alpha The legacy dashboard bundle was removed.
	 */
	...
	public static function announce_retired_filter() {
		...
		_deprecated_hook( 'jetpack_forms_alpha', 'jetpack-forms-8.1.0-alpha', '', 'The legacy Forms dashboard has been removed, so this filter no longer selects anything.' );
	}
	 ...
	 *
	 * @deprecated 8.1.0-alpha The legacy dashboard was retired.
	 */
	public function render_dashboard() {
		_deprecated_function( __METHOD__, 'jetpack-forms-8.1.0-alpha' );
		?>
