...
class Dashboard {
	 ...
	 *
	 * @var string
	 * @deprecated 8.2.0-alpha The legacy dashboard bundle was removed.
	 */
	 ...
	 *
	 * Mirrored by TOP_TABS in src/dashboard/constants.ts.
	 *
	 * @var string[]
	 */
	private const TOP_TABS = array( 'forms', 'responses' );
