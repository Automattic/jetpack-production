 ...
 *
 * @deprecated 6.6.0-alpha This class is no longer needed and has been removed from active use.
 */
class Dashboard_View_Switch {
	...
	public function init() {
		_deprecated_function( __METHOD__, 'jetpack-6.6.0-alpha' );
...
CSS
	 ...
	 *
	 * @deprecated 6.6.0-alpha Use Dashboard::is_jetpack_forms_admin_page() instead.
	 *
	 * @return boolean
	 */
	public function is_jetpack_forms_admin_page() {
		_deprecated_function( __METHOD__, 'jetpack-6.6.0-alpha', 'Dashboard::is_jetpack_forms_admin_page' );
		if ( ! function_exists( 'get_current_screen' ) ) {
			return false;
		}
	 ...
	 *
	 * @deprecated 6.6.0-alpha Use Dashboard::get_forms_admin_url() instead.
	 *
	...
	public function get_forms_admin_url( $tab = null, $force_inbox = false ) {
		_deprecated_function( __METHOD__, 'jetpack-6.6.0-alpha', 'Dashboard::get_forms_admin_url' );
	 ...
	 *
	 * @deprecated 6.6.0-alpha Use Dashboard::is_jetpack_forms_admin_page_available() instead.
	 *
	 * @return boolean
	 */
	public static function is_jetpack_forms_admin_page_available() {
		_deprecated_function( __METHOD__, 'jetpack-6.6.0-alpha', 'Dashboard::is_jetpack_forms_admin_page_available' );
