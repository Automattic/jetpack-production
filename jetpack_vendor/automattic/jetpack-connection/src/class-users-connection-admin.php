...
class Users_Connection_Admin {
	 ...
	 *
	 * @deprecated 8.12.0-alpha The CSS is enqueued on the `jetpack-connection-users-column` style handle by enqueue_scripts().
	 */
	public function add_connection_column_styles() {
		_deprecated_function( __METHOD__, 'connection-8.12.0-alpha', __CLASS__ . '::enqueue_scripts' );
		self::enqueue_connection_column_styles();
	}
