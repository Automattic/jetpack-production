...
## [1.54.1-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Fixed
- Pass Calypso environment during connection to redirect users to proper Calypso URL.
...
[1.54.1-alpha]: https://github.com/Automattic/jetpack-connection/compare/v1.54.0...v1.54.1-alpha
