...
## [8.7.3-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Changed
- Reduce per-request memory footprint on connected sites by deferring package version tracking to request shutdown.
...
[8.7.3-alpha]: https://github.com/Automattic/jetpack-connection/compare/v8.7.2...v8.7.3-alpha
