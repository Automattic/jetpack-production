...
## [1.56.0-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Added
- Add a filter to modify response for the `jetpack.idcUrlValidation` endpoint, add unit test.
...
[1.56.0-alpha]: https://github.com/Automattic/jetpack-connection/compare/v1.55.0...v1.56.0-alpha
