...
### Changed
- Update the Apple Podcasts category list to match the current taxonomy, validate topic input, and recommend a subcategory when a broad category is selected.
...
[1.1.1-alpha]: https://github.com/Automattic/jetpack-podcast/compare/v1.1.0...v1.1.1-alpha
