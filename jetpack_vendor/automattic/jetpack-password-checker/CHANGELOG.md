...
### Fixed
- Fail passwords whose entropy is below the minimum instead of reporting them as passed.
...
[0.5.2-alpha]: https://github.com/Automattic/jetpack-password-checker/compare/v0.5.1...v0.5.2-alpha
