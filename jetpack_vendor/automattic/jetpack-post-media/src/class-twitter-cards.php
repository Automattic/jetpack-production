...
class Twitter_Cards {
	 ...
	 *
	 * @deprecated 0.3.0-alpha Settings > Sharing renders the field itself.
	 */
	public static function settings_init() {
		_deprecated_function( __METHOD__, 'post-media-0.3.0-alpha', 'Automattic\Jetpack\Sharing_Likes\Settings\Twitter_Site_Tag::render' );
	}
	 ...
	 *
	 * @deprecated 0.3.0-alpha Settings > Sharing saves the field itself.
	 */
	public static function settings_validate() {
		_deprecated_function( __METHOD__, 'post-media-0.3.0-alpha', 'Automattic\Jetpack\Sharing_Likes\Settings\Twitter_Site_Tag::save' );
	}
