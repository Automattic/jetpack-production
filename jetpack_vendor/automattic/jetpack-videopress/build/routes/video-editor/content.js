...
__( "Creating your new video… Your current video stays unchanged.", "jetpack-videopress-pkg" );
__( "The source video changed. Reload the latest edits before creating a copy.", "jetpack-videopress-pkg" );
__( "Reload latest", "jetpack-videopress-pkg" );
__( "The new video was created, but its edits could not be processed. Your current video and edits are unchanged.", "jetpack-videopress-pkg" );
__( "The new video could not be created. Your current video and edits are unchanged.", "jetpack-videopress-pkg" );
__( "Open new video", "jetpack-videopress-pkg" );
__( "We could not confirm whether the new video was created. Your current video is unchanged. We’ll keep checking automatically. Please contact support if it remains unconfirmed.", "jetpack-videopress-pkg" );
__( "We could not confirm the new video’s status. We’ll keep checking automatically.", "jetpack-videopress-pkg" );
__( "Retry", "jetpack-videopress-pkg" );
__( "Creating video", "jetpack-videopress-pkg" );
...
__( "%s (edited)", "jetpack-videopress-pkg" );
__( "Save video edits", "jetpack-videopress-pkg" );
__( "Save as", "jetpack-videopress-pkg" );
__( "Update existing video", "jetpack-videopress-pkg" );
__( "Save as new video", "jetpack-videopress-pkg" );
__( "New video title", "jetpack-videopress-pkg" );
__( "Add the edited version to your library. The current video stays unchanged.", "jetpack-videopress-pkg" );
...
__( "The new video could not be created.", "jetpack-videopress-pkg" );
