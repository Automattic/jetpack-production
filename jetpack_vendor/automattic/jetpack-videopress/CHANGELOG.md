...
### Added
- VideoPress block: Add test IDs to query elements in integration tests

### Fixed
- Fix player loading screen on Android
...
[0.14.2-alpha]: https://github.com/Automattic/jetpack-videopress/compare/v0.14.1...v0.14.2-alpha
