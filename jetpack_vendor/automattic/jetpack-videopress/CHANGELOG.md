...
- VideoPress: extend the media endpoint with the jetpack_videopress_guid field
...
[0.2.2-alpha]: https://github.com/Automattic/jetpack-videopress/compare/v0.2.1...v0.2.2-alpha
