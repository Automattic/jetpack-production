...
- VideoPress: update post title and content via the /videopress/meta endpoint
...
[0.4.0-alpha]: https://github.com/Automattic/jetpack-videopress/compare/v0.3.1...v0.4.0-alpha
