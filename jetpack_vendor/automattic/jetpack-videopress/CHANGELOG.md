...
### Added
- Add error handling for .vtt track files upload process

### Changed
- Use WordPress `str_starts_with` polyfill.
...
[0.17.2-alpha]: https://github.com/Automattic/jetpack-videopress/compare/v0.17.1...v0.17.2-alpha
