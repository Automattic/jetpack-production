...
### Added
- Synced changes made in modules/publice/publicize.php and made sure the composer package for publicize has those changes.
...
[0.8.0-alpha]: https://github.com/Automattic/jetpack-publicize/compare/v0.7.1...v0.8.0-alpha
