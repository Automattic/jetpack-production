...
abstract class Publicize_Base {
	...
	public function get_remote_filesize( $image_url ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		_deprecated_function( __METHOD__, '0.66.3-alpha', 'add_jetpack_social_og_images' );
	 ...
	 *
	 * @deprecated 0.66.3-alpha use add_jetpack_social_og_images instead.
	 *
