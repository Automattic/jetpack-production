...
### Changed
- Social Links: Modified package file - new functions, modified function types, added imports
...
[0.4.5-alpha]: https://github.com/Automattic/jetpack-classic-theme-helper/compare/v0.4.4...v0.4.5-alpha
