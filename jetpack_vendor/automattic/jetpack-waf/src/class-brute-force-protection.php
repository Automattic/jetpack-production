...
class Brute_Force_Protection {
	 ...
	 *
	 * @deprecated 0.11.0-alpha Use ip_is_allowed()
	 *
	 * @param string $ip - the IP address.
	 */
	public static function ip_is_whitelisted( $ip ) {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::ip_is_allowed' );
	 ...
	 *
	 * @deprecated 0.11.0-alpha Use is_current_ip_allowed()
	 */
	public static function is_current_ip_whitelisted() {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::is_current_ip_allowed' );
