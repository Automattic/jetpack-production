...
class Brute_Force_Protection_Shared_Functions {
	 ...
	 *
	 * @deprecated 0.11.0-alpha Use format_allow_list()
	 */
	public static function format_whitelist() {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::format_allow_list' );
	 ...
	 *
	 * @deprecated 0.11.0-alpha Use get_local_allow_list()
	 */
	public static function get_local_whitelist() {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::get_local_allow_list' );
	 ...
	 *
	 * @deprecated 0.11.0-alpha Use get_global_allow_list()
	 */
	public static function get_global_whitelist() {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::get_global_allow_list' );
	 ...
	 * Save IP allow list.
	 *
	 * @deprecated 0.11.0-alpha Use save_allow_list()
	 *
	...
	public static function save_whitelist( $allow_list, $global = false ) {
		_deprecated_function( __METHOD__, 'waf-0.11.0-alpha', __CLASS__ . '::save_allow_list' );
