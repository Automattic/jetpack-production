...
class Waf_Stats {
	 ...
	 *
	 * @deprecated 0.20.1-alpha Use Automattic\Jetpack\Waf\Waf_Blocklog_Manager API instead.
	 */
	public static function get_ip_allow_list_count() {
		_deprecated_function( __METHOD__, 'waf-0.20.1-alpha', 'Automattic\Jetpack\Waf\Waf_Blocklog_Manager' );
