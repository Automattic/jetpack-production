...
class Waf_Stats {
	 ...
	 *
	 * @deprecated 0.12.3-alpha Use Automattic\Jetpack\Waf\Waf_Stats::get_automatic_rules_last_updated() to version the rules instead.
	 */
	public static function get_rules_version() {
		_deprecated_function( __METHOD__, 'waf-0.12.3-alpha', 'Automattic\Jetpack\Waf\Waf_Stats::get_automatic_rules_last_updated' );
