...
### Added
- Added hooks for generating the rules.php file. Combined new functionality with the waf runner. Updated class names to Snake_Case.
...
[0.3.0-alpha]: https://github.com/Automattic/jetpack-waf/compare/v0.2.0...v0.3.0-alpha
