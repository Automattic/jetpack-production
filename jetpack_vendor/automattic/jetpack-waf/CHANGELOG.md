...
### Added
- Added brute force protection to the WAF configuration REST API endpoints
- Move the brute force protection module into the package.
...
- Use WAF IP allow list option in brute force protection feature.
...
[0.11.0-alpha]: https://github.com/Automattic/jetpack-waf/compare/v0.10.2...v0.11.0-alpha
