...
## [1.10.5-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Changed
- Updated backup layout to improve consistency and remove redundancy.
...
[1.10.5-alpha]: https://github.com/Automattic/jetpack-backup/compare/v1.10.4...v1.10.5-alpha
