...
### Fixed
- Logo: Add an admin menu variant that uses the active WordPress color scheme.
...
[4.0.1-alpha]: https://github.com/Automattic/jetpack-logo/compare/v4.0.0...v4.0.1-alpha
[4.0.0]: https://github.com/Automattic/jetpack-logo/compare/v3.0.9...v4.0.0
