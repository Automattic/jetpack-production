...
class Identity_Crisis {
	 ...
	 *
	 * @deprecated since 0.17.0-alpha Use `@automattic/jetpack-idc` instead.
	 * @return string
	 */
	public static function get_safe_mod_doc_url() {
		_deprecated_function( __METHOD__, 'package-0.17.0-alpha' );
	 ...
	 *
	 * @deprecated  0.17.0-alpha Use `@automattic/jetpack-idc` instead.
	 * @return void
	 */
	...
	public function render_notice_first_step() {
		_deprecated_function( __METHOD__, ' 0.17.0-alpha' );
		?>
