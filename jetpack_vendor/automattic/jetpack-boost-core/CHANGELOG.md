...
### Fixed
- Speed Scores: ensure the correct home page is checked when sites are using WP in a subfolder.
...
[0.3.11-alpha]: https://github.com/Automattic/jetpack-boost-core/compare/v0.3.10...v0.3.11-alpha
