...
<form action="%2$s" method="post" target="_blank" style="display:inline-grid;justify-items:center;align-content:start;gap:0.5rem;">
  ...
  <section style="font-size: 0.75rem;"> Powered by <img src="https://www.paypalobjects.com/paypal-ui/logos/svg/paypal-wordmark-color.svg" alt="paypal" style="height:0.875rem;vertical-align:middle;"/></section>
	 ...
	 *
	 * @since 0.9.0
	 * @since 0.9.0-alpha Public, runs on `init`, and no-ops unless the API-managed buttons are enabled.
	 * @return void
	 */
	 ...
	 *
	 * @since 0.9.0
	 * @since 0.9.0-alpha Defers to `init` and no-ops unless the API-managed buttons are enabled.
	 */
