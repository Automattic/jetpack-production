 ...
 *
 * Note: These styles can be overridden by calling jetpack_my_jetpack_override_style()
 ...
 */
function jetpack_my_jetpack_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function jetpack_my_jetpack_register_package_styles( $styles ) {
	...
	foreach ( $styles_data as $style_data ) {
		jetpack_my_jetpack_override_style(
			$styles,
			$style_data['handle'],
...
add_action( 'wp_default_styles', 'jetpack_my_jetpack_register_package_styles' );
