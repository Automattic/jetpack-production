...
### Changed
- My Jetpack: Update Jetpack AI interstitial to repeat the feature's list on all the tiers.
...
[4.1.3-alpha]: https://github.com/Automattic/jetpack-my-jetpack/compare/4.1.2...4.1.3-alpha
