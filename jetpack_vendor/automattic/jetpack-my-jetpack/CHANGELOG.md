...
### Added
- Add value to the inactive state on the VideoPress card in My Jetpack
...
[4.32.1-alpha]: https://github.com/Automattic/jetpack-my-jetpack/compare/4.32.0...4.32.1-alpha
