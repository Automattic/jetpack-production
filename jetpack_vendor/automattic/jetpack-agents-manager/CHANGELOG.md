...
### Added
- Expose the Automattician tracking signal to the Agents Manager frontend.
...
[0.9.4-alpha]: https://github.com/Automattic/jetpack-agents-manager/compare/v0.9.3...v0.9.4-alpha
