 ...
 *
 * @deprecated 0.11.0-alpha Use Automattic\Jetpack\Connection\REST_Jetpack_AI_JWT instead.
 */
class WP_REST_Jetpack_AI_JWT extends REST_Jetpack_AI_JWT {
	...
	public function __construct() {
		_deprecated_class( __CLASS__, 'agents-manager-0.11.0-alpha', REST_Jetpack_AI_JWT::class );
