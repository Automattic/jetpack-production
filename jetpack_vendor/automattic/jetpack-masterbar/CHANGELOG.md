...
## [0.27.11-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Fixed
- Admin Menu: fix passing JSON string instead of array to JITM get_messages().
...
[0.27.11-alpha]: https://github.com/Automattic/jetpack-masterbar/compare/v0.27.10...v0.27.11-alpha
