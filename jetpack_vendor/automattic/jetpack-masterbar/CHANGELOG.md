...
### Fixed
- Fix admin menu upsell banner layout shift by rendering server-side instead of via AJAX.
...
[0.27.14-alpha]: https://github.com/Automattic/jetpack-masterbar/compare/v0.27.13...v0.27.14-alpha
