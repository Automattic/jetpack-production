...
### Added
- Add a script module polyfill for @wordpress/widget-primitives.
...
[0.4.0-alpha]: https://github.com/Automattic/jetpack-wp-build-polyfills/compare/v0.3.0...v0.4.0-alpha
