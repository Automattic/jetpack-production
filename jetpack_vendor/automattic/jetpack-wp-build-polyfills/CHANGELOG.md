...
### Changed
- Pin @wordpress/private-apis to an exact version instead of the floating next tag
...
[0.1.17-alpha]: https://github.com/Automattic/jetpack-wp-build-polyfills/compare/v0.1.16...v0.1.17-alpha
