...
- Date controls: build the comparison menu from the applied range and restore the same-period-last-week option.
...
- Tables: fall back to the last page instead of reporting no results when a date range returns fewer rows than the current page.
...
[0.5.0-alpha]: https://github.com/Automattic/jetpack-premium-analytics/compare/0.4.0...0.5.0-alpha
