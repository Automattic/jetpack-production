...
return array(
	array(
		...
		'help'         => array( 'content' => 'Your totals since you started tracking — views, visitors, posts, and comments.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'Your totals for the selected year — posts, words, likes, and comments.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		'name'         => 'jpa/author-performance',
		'dir_name'     => 'author-performance',
		'title'        => 'Author performance',
		'description'  => 'How the posts of the author being viewed performed over the selected period.',
		'help'         => array( 'content' => 'This author’s views over the selected period. Views come from the site’s 20 most viewed authors per period, so on a site with more authors, a period where this author ranks lower counts as zero.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		'name'         => 'jpa/author-top-posts',
		'dir_name'     => 'author-top-posts',
		'title'        => 'Top viewed posts',
		'description'  => 'The most viewed posts of the author being viewed over the selected period.',
		'help'         => array( 'content' => 'This author’s posts, ranked by views for the selected period.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'Headline stats for a single email. The Opens view shows total sends, unique opens, total opens, and open rate; the Clicks view shows total opens, total clicks, and click rate. Rates are measured against total sends, and show a dash when those went unrecorded. Figures are all-time and are not affected by the dashboard date range.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'description'  => 'Opens or clicks, with their rates, for your latest emails.',
		'help'         => array( 'content' => 'Your most recently sent emails, with their opens and open rate, or clicks and click rate.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'Your most recently published post, with its headline views, likes, and comments.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'The single day your site drew the most views since you started tracking, and how much of your all-time views it accounts for.', 'links' => array( array( 'label' => 'Learn more', 'href' => 'https://wordpress.com/support/stats/learn-insights-about-your-website/' ) ) ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'The day of the week and the hour of the day when your site is viewed most, with each one\'s share of your views.', 'links' => array( array( 'label' => 'Learn more', 'href' => 'https://wordpress.com/support/stats/learn-insights-about-your-website/' ) ) ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'dir_name'     => 'popular-days',
		'title'        => 'Popular days',
		'description'  => 'The day of the week that draws the most views, with the distribution across the week.',
		'help'         => array( 'content' => 'The days of the week when your site received the most views on average.', 'links' => array( array( 'label' => 'Learn more', 'href' => 'https://wordpress.com/support/stats/learn-insights-about-your-website/' ) ) ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'dir_name'     => 'popular-hours',
		'title'        => 'Popular hours',
		'description'  => 'The hour of the day that draws the most views, with the distribution across the day.',
		'help'         => array( 'content' => 'The hours of the day when your site received the most views on average. Ranges longer than a year show the most recent 12 months.', 'links' => array( array( 'label' => 'Learn more', 'href' => 'https://wordpress.com/support/stats/learn-insights-about-your-website/' ) ) ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'title'        => 'Most popular in the last year',
	...
	array(
		...
		'description'  => 'Your all-time subscribers and social followers, plus a paid and free breakdown or how many you had 30, 60, and 90 days ago.',
		'help'         => array( 'content' => 'Your all-time subscribers, plus social followers if you have them. Sites with paid subscribers also see paid and free subscribers; other sites see their count 30, 60, and 90 days ago.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'description'  => 'Views, impressions, hours watched, and retention rate for the video being viewed over the selected period.',
		'help'         => array( 'content' => 'Views, impressions, hours watched, and retention rate for the video being viewed over the selected period.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'Impressions, average CPM, and the revenue they earned over the selected period.', 'links' => array( array( 'label' => 'Learn more', 'href' => 'https://wordpress.com/support/wordads-and-earn/' ) ) ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'What each billing month earned from programmatic ads, and whether it has been paid. Whole months only, so the month in progress isn’t listed.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
	...
	array(
		...
		'help'         => array( 'content' => 'What your ads have earned since you started, what has been paid out, and what is still owed. Lifetime totals — these don’t follow the date selection. Payments go out once the outstanding amount reaches $100.' ),
		'icon'         => null,
		'actions'      => null,
		'has_render'   => true,
		'has_widget'   => true,
