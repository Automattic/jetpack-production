...
__( "Are the new Traffic and Insights tabs ready to replace the old ones?", "jetpack-premium-analytics-pkg" );
...
__( "It'll help us decide what to fix before the new Traffic and Insights tabs replace the old ones. You can send more any time from the page options menu.", "jetpack-premium-analytics-pkg" );
...
__( "Switch off the new Traffic and Insights tabs?", "jetpack-premium-analytics-pkg" );
__( "You'll go back to your current Stats. You can switch the new Traffic and Insights tabs on again from the Modules Visibility setting.", "jetpack-premium-analytics-pkg" );
__( "Before you go — are the new Traffic and Insights tabs ready to replace the old ones?", "jetpack-premium-analytics-pkg" );
