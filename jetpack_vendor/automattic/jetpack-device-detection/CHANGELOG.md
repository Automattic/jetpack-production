...
### Added
- Add is_agent() method for detecting bots, AI assistants, and programmatic HTTP clients.
...
[3.4.0-alpha]: https://github.com/Automattic/jetpack-device-detection/compare/v3.3.0...v3.4.0-alpha
