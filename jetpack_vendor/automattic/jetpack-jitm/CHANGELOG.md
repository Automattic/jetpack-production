...
## [4.3.19-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Fixed
- Fixed JITM REST endpoint query string parsing where the first parameter was corrupted.
...
[4.3.19-alpha]: https://github.com/Automattic/jetpack-jitm/compare/v4.3.18...v4.3.19-alpha
