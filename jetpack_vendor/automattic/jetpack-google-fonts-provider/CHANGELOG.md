...
### Added
- Add support for new WP Fonts API in Google Fonts provider.
...
[0.5.0-alpha]: https://github.com/Automattic/jetpack-google-fonts-provider/compare/v0.4.2...v0.5.0-alpha
