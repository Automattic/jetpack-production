...
### Added
- Serve the license activation illustrations from the package and add their base URL to the admin script data.
...
[4.1.0-alpha]: https://github.com/Automattic/jetpack-licensing/compare/v4.0.0...v4.1.0-alpha
[4.0.0]: https://github.com/Automattic/jetpack-licensing/compare/v3.1.9...v4.0.0
