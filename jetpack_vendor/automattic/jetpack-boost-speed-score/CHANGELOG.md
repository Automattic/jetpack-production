...
### Fixed
- Avoid a PHP warning when reading speed score history entries saved before the theme was recorded.
- Record the time of every completed speed score measurement, not only the ones that change the score.
...
[0.6.0-alpha]: https://github.com/Automattic/jetpack-boost-speed-score/compare/v0.5.0...v0.6.0-alpha
