...
class Jetpack_Core_Json_Api_Endpoints {
	 ...
	 *
	 * @since 5.5.0
	 * @deprecated 16.2-a.0 Use Automattic\Jetpack\Connection\Manager::get_connected_site_data().
	 *
	 * @return stdClass|WP_Error
	 */
	public static function site_data() {
		_deprecated_function( __METHOD__, 'jetpack-16.2-a.0', 'Automattic\Jetpack\Connection\Manager::get_connected_site_data' );
	 ...
	 *
	 * @since 4.3.0
	 * @deprecated 16.2-a.0 Use Automattic\Jetpack\Connection\REST_Connector::site_data_response().
	 *
	 * @return WP_Error|WP_HTTP_Response|WP_REST_Response
	 */
	public static function get_site_data() {
		_deprecated_function( __METHOD__, 'jetpack-16.2-a.0', 'Automattic\Jetpack\Connection\REST_Connector::site_data_response' );
