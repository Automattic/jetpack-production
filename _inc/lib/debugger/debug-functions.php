 ...
 *
 * @deprecated 15.9-a.6 Site Health integration is now handled by the connection package.
 ...
 *
 * @since 7.3.0
 * @deprecated 15.9-a.6 Use Automattic\Jetpack\Connection\Site_Health instead.
 */
function jetpack_debugger_ajax_local_testing_suite() {
	_deprecated_function( __FUNCTION__, 'jetpack-15.9-a.6' );
