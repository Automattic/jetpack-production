 ...
 *
 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan instead.
 *
...
class Jetpack_Plan {
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::PLAN_OPTION
	 *
	 * @var string
	 */
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::SITE_PRODUCTS_OPTION
	 *
	 * @var string
	 */
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::PLAN_DATA
	 *
	 * @var array
	 */
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::update_from_sites_response instead.
	 *
	...
	public static function update_from_sites_response( $response ) {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::update_from_sites_response' );
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::refresh_from_wpcom instead.
	 *
	 * @access public
	 * @static
	 *
	...
	public static function refresh_from_wpcom() {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::refresh_from_wpcom' );
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::get instead.
	 *
	 * @access public
	 * @static
	 *
	...
	public static function get() {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::get' );
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::get_products instead.
	 *
	 * @access public
	 * @static
	 *
	...
	public static function get_products() {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::get_products' );
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::get_minimum_plan_for_feature instead.
	 *
	...
	public static function get_minimum_plan_for_feature( $feature ) {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::get_minimum_plan_for_feature' );
	 ...
	 *
	 * @deprecated 12.3-a.6 use Automattic\Jetpack\Current_Plan::supports instead.
	 *
	 * @access public
	 * @static
	 *
	...
	public static function supports( $feature ) {
		_deprecated_function( __METHOD__, '12.3-a.6', 'Automattic\Jetpack\Current_Plan::supports' );
