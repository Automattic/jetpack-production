...
class Jetpack_Gutenberg {
	 ...
	 * @since 8.1.0
	 *
	 * @deprecated 14.6-a.8 Use Automattic\Jetpack\Blocks::get_variation instead. Requires the blocks pacakge.
	 *
	 * @return string $block_varation production|beta|experimental
	 */
	public static function blocks_variation() {
		_deprecated_function( __METHOD__, '14.6-a.8', 'Automattic\\Jetpack\\Blocks::get_variation' );
