 ...
 *                                    Default 'false'.
 */
function jetpack_plugin_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function jetpack_plugin_register_package_scripts( $scripts ) {
	...
	foreach ( $scripts_data as $script_data ) {
		...
		jetpack_plugin_override_script(
			$scripts,
			$script_data['handle'],
...
add_action( 'wp_default_scripts', 'jetpack_plugin_register_package_scripts' );
