 ...
 *
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN_Core::cdn_url instead.
...
function jetpack_photon_url( $image_url, $args = array(), $scheme = null ) {
	_deprecated_function( __FUNCTION__, 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN_Core::cdn_url' );
 ...
 *
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN_Core::parse_wpcom_query_args instead.
...
function jetpack_photon_parse_wpcom_query_args( $args, $image_url ) {
	_deprecated_function( __FUNCTION__, 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN_Core::parse_wpcom_query_args' );
 ...
 *
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN_Core::cdn_url_scheme instead.
...
function jetpack_photon_url_scheme( $url, $scheme ) {
	_deprecated_function( __FUNCTION__, 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN_Core::cdn_url_scheme' );
 ...
 *
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN_Core::banned_domains instead.
...
function jetpack_photon_banned_domains( $skip, $image_url ) {
	_deprecated_function( __FUNCTION__, 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN_Core::banned_domains' );
 ...
 *
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN_Core::support_text_widgets instead.
 * @access public
 * @param string $content Content from text widget.
 * @return string
 */
function jetpack_photon_support_text_widgets( $content ) {
	_deprecated_function( __FUNCTION__, 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN_Core::support_text_widgets' );
