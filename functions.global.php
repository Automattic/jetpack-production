...
function jetpack_get_vary_headers( $headers = array() ) {
	_deprecated_function( __FUNCTION__, '14.8-a.4', 'Automattic\Jetpack\Status\Request::get_vary_headers' );
...
function jetpack_is_frontend() {
	_deprecated_function( __FUNCTION__, '14.8-a.4', 'Automattic\Jetpack\Status\Request::is_frontend' );
