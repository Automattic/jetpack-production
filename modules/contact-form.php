 ...
 *
 * @deprecated 13.4-a.10 Use Automattic\Jetpack\Forms\ContactForm\Util::register_pattern
 */
function jetpack_form_register_pattern() {
	_deprecated_function( __METHOD__, 'jetpack-13.4-a.10', 'Automattic\Jetpack\Forms\ContactForm\Util::register_pattern' );
	$category_slug = 'forms';
