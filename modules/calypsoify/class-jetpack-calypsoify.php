 ...
 *
 * @deprecated 13.6-a.0 Use Automattic\Jetpack\Calypsoify instead.
 *
...
class Jetpack_Calypsoify extends Calypsoify {
	...
	public static function get_instance() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::get_instance' );
	...
	public function setup() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::setup' );
		return parent::setup();
	}
	...
	public function enqueue_for_gutenberg() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::enqueue_for_gutenberg' );
	...
	public function get_calypso_url( $post_id = null ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable -- in process of deprecating hence unused parameter.
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::get_calypso_url' );
	...
	public function get_close_gutenberg_url() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::get_close_gutenberg_url' );
	...
	public function get_switch_to_classic_editor_url() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::get_switch_to_classic_editor_url' );
	...
	public function check_meta() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::check_meta' );
	...
	public function is_post_type_gutenberg( $post_type ) { // phpcs:ignore  VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable -- in process of deprecating hence unused parameter.
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::is_post_type_gutenberg' );
	...
	public function is_page_gutenberg() {
		_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Calypsoify\\Jetpack_Calypsoify::is_page_gutenberg' );
