 ...
 *
 * @deprecated 16.3-a.4 Settings > Sharing renders the field itself.
 *
 * @return void
 */
function sharing_global_resources() {
	_deprecated_function( __FUNCTION__, 'jetpack-16.3-a.4', 'Automattic\Jetpack\Sharing_Likes\Settings\Sharing_Resources::render' );
}

/**
 * Save settings to disable CSS and JS normally enqueued by our feature.
 *
 * @deprecated 16.3-a.4 Settings > Sharing saves the field itself.
 *
 * @return void
 */
function sharing_global_resources_save() {
	_deprecated_function( __FUNCTION__, 'jetpack-16.3-a.4', 'Automattic\Jetpack\Sharing_Likes\Settings\Sharing_Resources::save' );
}
