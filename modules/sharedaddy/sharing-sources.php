...
abstract class Sharing_Source {
	...
	public function get_link( $url, $text, $accessible_name = '', $query = '', $id = false, $data_attributes = array() ) {
		 ...
		 *
		 * @since 3.4.0
		 * @deprecated 14.6-a.2 Use jetpack_sharing_accessible_name instead.
		 *
		 ...
		 * @param array $args Array of sharing service options.
		 */
		$accessible_name = apply_filters_deprecated( 'jetpack_sharing_display_title', array( $accessible_name, $this, $id, $args ), '14.6-a.2', 'jetpack_sharing_accessible_name' );
