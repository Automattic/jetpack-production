 ...
 * @access public
 * @deprecated 11.5-a.4 Use WPCOM_Stats available methodsinstead.
...
function stats_get_from_restapi( $args = array(), $resource = '' ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.4', 'Please checkout the methods available in Automattic\Jetpack\Stats\WPCOM_Stats' );
