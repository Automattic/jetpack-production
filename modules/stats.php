...
function jetpack_is_dnt_enabled() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Main::jetpack_is_dnt_enabled' );
...
function stats_map_meta_caps( $caps, $cap, $user_id ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Main::map_meta_caps' );
...
function stats_template_redirect() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Main::template_redirect' );
...
function stats_build_view_data() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Tracking_Pixel::build_view_data' );
...
function stats_footer() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Tracking_Pixel::add_to_footer' );
...
function stats_render_footer( $data ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Tracking_Pixel::render_footer' );
...
function stats_render_amp_footer( $data ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Tracking_Pixel::render_amp_footer' );
...
function stats_get_options() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Options::get_options' );
...
function stats_get_option( $option ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Options::get_option' );
...
function stats_set_option( $option, $value ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Options::set_option' );
...
function stats_set_options( $options ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Options::set_options' );
...
function stats_upgrade_options( $options ) {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2', 'Automattic\Jetpack\Stats\Options::upgrade_options' );
...
function stats_get_blog() {
	_deprecated_function( __METHOD__, 'jetpack-11.5-a.2' );
