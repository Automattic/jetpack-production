 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Posts_List_Page_Notification instead.
 *
 * @package Jetpack
 */
...
class Posts_List_Page_Notification {
	...
	public function __construct( $posts_page_id, $show_on_front, $page_on_front ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::__construct' );
	...
	public function init_actions() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::init_actions' );
	...
	public static function init() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::init' );
	...
	public function disable_posts_page( $caps, $cap, $user_id, $args ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::disable_posts_page' );
	...
	public function enqueue_css() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::enqueue_css' );
	...
	public function add_posts_page_css_class( $classes, $class, $post_id ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::add_posts_page_css_class' );
	...
	public function add_notification_icon() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Posts_List_Page_Notification::add_notification_icon' );
