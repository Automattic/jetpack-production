 ...
 * Masterbar file.
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Masterbar instead.
 *
...
class Masterbar {
	...
	public function __construct() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::__construct' );
	...
	public function init() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::init' );
	...
	public function maybe_logout_user_from_wpcom( $redirect_to ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::maybe_logout_user_from_wpcom' );
	...
	public function admin_body_class( $admin_body_classes ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::admin_body_class' );
	...
	public function remove_core_styles() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::remove_core_styles' );
	...
	public function add_styles_and_scripts() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_styles_and_scripts' );
	...
	public function replace_core_masterbar() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::replace_core_masterbar' );
	...
	protected function build_wp_admin_interface_bar( $bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::build_wp_admin_interface_bar' );
		$nodes = array();
	...
	protected function add_wpcom_profile_link( $bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_wpcom_profile_link' );
		$custom_node = array(
			'parent' => 'user-actions',
	...
	public function clear_core_masterbar( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::clear_core_masterbar' );
	...
	public function build_wpcom_masterbar( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::build_wpcom_masterbar' );
	...
	public function get_locale() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::get_locale' );
	...
	public function get_jetpack_locale( $slug = '' ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::get_jetpack_locale' );
	...
	public function install_locale( $locale = '' ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::install_locale' );
	...
	public function unload_non_default_textdomains_on_wpcom_user_locale_switch( $wpcom_locale ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::unload_non_default_textdomains_on_wpcom_user_locale_switch' );
	...
	public function hide_language_dropdown() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::hide_language_dropdown' );
	...
	public function replace_language_dropdown() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::replace_language_dropdown' );
	...
	public function add_notifications( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_notifications' );
	...
	public function add_reader_submenu( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_reader_submenu' );
	...
	public function create_menu_item_pair( $primary, $secondary ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::create_menu_item_pair' );
	...
	public function create_menu_item_anchor( $class, $url, $label, $id ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::create_menu_item_anchor' );
	...
	public function wpcom_adminbar_add_secondary_groups( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::wpcom_adminbar_add_secondary_groups' );
	...
	public function add_me_submenu( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_me_submenu' );
	...
	public function add_write_button( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_write_button' );
	...
	public function add_my_sites_submenu( $wp_admin_bar ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Masterbar::add_my_sites_submenu' );
