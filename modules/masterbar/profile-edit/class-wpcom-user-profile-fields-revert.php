 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\WPCOM_User_Profile_Fields_Revert instead.
 *
...
class WPCOM_User_Profile_Fields_Revert {
	...
	public function __construct( Connection_Manager $connection_manager ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_User_Profile_Fields_Revert::__construct' );
	...
	public function revert_user_data_on_wp_admin_profile_update( $data, $update, $id ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_User_Profile_Fields_Revert::revert_user_data_on_wp_admin_profile_update' );
	...
	public function revert_user_meta_on_wp_admin_profile_change( $meta, $user, $update ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_User_Profile_Fields_Revert::revert_user_meta_on_wp_admin_profile_change' );
	...
	public function disable_send_email_change_email( $send, $user ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_User_Profile_Fields_Revert::disable_send_email_change_email' );
	...
	public function disable_email_notification( $user_id ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_User_Profile_Fields_Revert::disable_email_notification' );
