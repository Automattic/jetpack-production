 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Dashboard_Switcher_Tracking instead.
 *
...
class Dashboard_Switcher_Tracking {
	...
	public function __construct( Tracking $tracking, callable $wpcom_tracking, $plan ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::__construct' );
	...
	public function record_switch_event( $screen, $view ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::record_switch_event' );
	...
	public static function get_plan() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::get_plan' );
	...
	public static function wpcom_tracks_record_event( $event_props ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::wpcom_tracks_record_event' );
	...
	public static function get_jetpack_tracking_product() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::get_jetpack_tracking_product' );
	...
	public static function mark_jetpack_tos_as_read( $option_value, $option_name ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Dashboard_Switcher_Tracking::mark_jetpack_tos_as_read' );
