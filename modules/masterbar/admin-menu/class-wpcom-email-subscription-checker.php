 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\WPCOM_Email_Subscription_Checker instead.
 *
...
class WPCOM_Email_Subscription_Checker {
	...
	public function has_email() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_Email_Subscription_Checker::has_email' );
