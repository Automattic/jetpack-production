...
_deprecated_file( __FILE__, 'jetpack-13.7-a.0' );
...
function should_customize_nav( $admin_menu_class ) {
	_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\should_customize_nav' );
...
function hide_customizer_menu_on_block_theme() {
	_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\hide_customizer_menu_on_block_theme' );
	add_action(
		'init',
		function () {
...
function get_admin_menu_class() {
	_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\get_admin_menu_class' );
...
if ( should_customize_nav( $admin_menu_class ) ) {
	...
	function dashboard_quick_switcher_record_usage( $screen, $view ) {
		_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\dashboard_quick_switcher_record_usage' );
