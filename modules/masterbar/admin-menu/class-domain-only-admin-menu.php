 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Domain_Only_Admin_Menu instead.
 *
...
class Domain_Only_Admin_Menu extends Masterbar_Domain_Only_Admin_Menu {
	...
	public function __construct() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Domain_Only_Admin_Menu::__construct' );
		parent::__construct();
	}
	...
	public function set_email_subscription_checker( $email_subscriptions_checker ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Domain_Only_Admin_Menu::set_email_subscription_checker' );
	...
	public function reregister_menu_items() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Domain_Only_Admin_Menu::reregister_menu_items' );
