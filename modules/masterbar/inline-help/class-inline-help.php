 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Inline_Help instead.
 *
...
class Inline_Help {
	...
	public function __construct() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Inline_Help::__construct' );
	...
	public function register_actions( $current_screen ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Inline_Help::register_actions' );
	...
	public function add_fab_icon() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Inline_Help::add_fab_icon' );
	...
	public function add_fab_styles() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Inline_Help::add_fab_styles' );
