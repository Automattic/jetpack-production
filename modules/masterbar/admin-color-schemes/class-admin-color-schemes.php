 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\Admin_Color_Schemes instead.
 *
...
class Admin_Color_Schemes {
	...
	public function __construct() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::__construct' );
	...
	public function register_admin_color_meta() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::register_admin_color_meta' );
	...
	public function update_admin_color_permissions_check( $allowed, $meta_key, $object_id ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::update_admin_color_permissions_check' );
	...
	public function get_admin_color_scheme_url( $color_scheme ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::get_admin_color_scheme_url' );
	...
	public function register_admin_color_schemes() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::register_admin_color_schemes' );
	...
	public function enqueue_core_color_schemes_overrides() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\Admin_Color_Schemes::enqueue_core_color_schemes_overrides' );
