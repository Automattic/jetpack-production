...
function register_css_nudge_control( \WP_Customize_Manager $customize_manager ) {
	_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\register_css_nudge_control' );
...
function load_bootstrap_on_init() {
	_deprecated_function( __FUNCTION__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\load_bootstrap_on_init' );
	/**
