 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\WPCOM_Additional_CSS_Manager instead.
 *
 * @package Jetpack
 */
...
class WPCOM_Additional_CSS_Manager {
	...
	public function __construct( $domain ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_Additional_CSS_Manager::__construct' );
	...
	public function register_nudge( \WP_Customize_Manager $wp_customize_manager ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\WPCOM_Additional_CSS_Manager::register_nudge' );
