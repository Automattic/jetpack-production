 ...
 *
 * @deprecated 13.7-a.0 Use Automattic\Jetpack\Masterbar\CSS_Customizer_Nudge instead.
 *
 * @package Jetpack
 */
...
class CSS_Customizer_Nudge {
	...
	public function __construct( $cta_url, $nudge_copy, $control_name = 'custom_css' ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\CSS_Customizer_Nudge::__construct' );
	...
	public function customize_controls_enqueue_scripts_nudge() {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\CSS_Customizer_Nudge::customize_controls_enqueue_scripts_nudge' );
	...
	public function customize_register_nudge( \WP_Customize_Manager $wp_customize ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\CSS_Customizer_Nudge::customize_register_nudge' );
	...
	public function create_css_nudge_control( \WP_Customize_Manager $wp_customize ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\CSS_Customizer_Nudge::create_css_nudge_control' );
	...
	public function create_css_nudge_section( \WP_Customize_Manager $wp_customize ) {
		_deprecated_function( __METHOD__, 'jetpack-13.7-a.0', 'Automattic\\Jetpack\\Masterbar\\CSS_Customizer_Nudge::create_css_nudge_section' );
