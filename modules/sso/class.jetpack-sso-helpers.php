...
if ( ! class_exists( 'Jetpack_SSO_Helpers' ) ) :
	...
	class Jetpack_SSO_Helpers {
		...
		public static function should_hide_login_form() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::should_hide_login_form' );
		...
		public static function match_by_email() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::match_by_email' );
		...
		public static function new_user_override( $user_data = null ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::new_user_override' );
		...
		public static function is_two_step_required() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::is_two_step_required' );
		...
		public static function bypass_login_forward_wpcom() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::bypass_login_forward_wpcom' );
		...
		public static function show_sso_login() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::show_sso_login' );
		...
		public static function is_require_two_step_checkbox_disabled() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::is_require_two_step_checkbox_disabled' );
		...
		public static function is_match_by_email_checkbox_disabled() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::is_match_by_email_checkbox_disabled' );
		...
		public static function allowed_redirect_hosts( $hosts, $api_base = JETPACK__API_BASE ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::allowed_redirect_hosts' );
		...
		public static function generate_user( $user_data ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Utils::generate_user' );
		...
		public static function extend_auth_cookie_expiration_for_sso() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::extend_auth_cookie_expiration_for_sso' );
		...
		public static function display_sso_form_for_action( $action ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::display_sso_form_for_action' );
		...
		public static function get_json_api_auth_environment() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::get_json_api_auth_environment' );
		...
		public static function get_custom_login_url() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::get_custom_login_url' );
		...
		public static function clear_wpcom_profile_cookies() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::clear_wpcom_profile_cookies' );
		...
		public static function delete_connection_for_user( $user_id ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\Helpers::delete_connection_for_user' );
		...
		public static function is_user_connected( $user_id = 0 ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager->is_user_connected' );
