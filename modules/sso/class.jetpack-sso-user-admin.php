...
if ( ! class_exists( 'Jetpack_SSO_User_Admin' ) ) :
	...
	class Jetpack_SSO_User_Admin {
		...
		public function __construct() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin' );
		}
		...
		public function jetpack_new_users_styles() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->jetpack_new_users_styles' );
		}
		...
		public function set_user_query( $args ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->set_user_query' );
		}
		...
		public function revoke_user_invite( $user_id ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->revoke_user_invite' );
		}
		...
		public function handle_invitation_results() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->handle_invitation_results' );
		}
		...
		public function invite_user_to_wpcom() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->invite_user_to_wpcom' );
		}
		...
		public function send_revoke_wpcom_invite( $invite_id ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->send_revoke_wpcom_invite' );
		}
		...
		public function handle_request_revoke_invite() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->handle_request_revoke_invite' );
		}
		...
		public function handle_request_resend_invite() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->handle_request_resend_invite' );
		}
		...
		public function jetpack_user_table_row_actions( $actions, $user_object ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->jetpack_user_table_row_actions' );
		}
		...
		public function render_invitation_email_message() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->render_invitation_email_message' );
		}
		...
		public function render_invitations_notices_for_deleted_users() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->render_invitations_notices_for_deleted_users' );
		}
		...
		public function render_wpcom_invite_checkbox( $type ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->render_wpcom_invite_checkbox' );
		}
		...
		public function render_wpcom_external_user_checkbox( $type ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->render_wpcom_external_user_checkbox' );
		}
		...
		public function render_custom_email_message_form_field( $type ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->render_custom_email_message_form_field' );
		}
		...
		public function should_send_wp_mail_new_user( $send_wp_email ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->should_send_wp_mail_new_user' );
		}
		...
		public function send_wpcom_mail_user_invite( $errors, $update, $user ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->send_wpcom_mail_user_invite' );
		}
		...
		public function jetpack_user_connected_th( $columns ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->jetpack_user_connected_th' );
		}
		...
		public static function get_pending_cached_wpcom_invite( $email ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->get_pending_cached_wpcom_invite' );
		}
		...
		public function jetpack_show_connection_status( $val, $col, $user_id ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->jetpack_show_connection_status' );
		}
		...
		public function create_error_notice_and_redirect( $query_params ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->create_error_notice_and_redirect' );
		}
		...
		public function jetpack_user_table_styles() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\SSO\\User_Admin->jetpack_user_table_styles' );
		}
	}
endif;
