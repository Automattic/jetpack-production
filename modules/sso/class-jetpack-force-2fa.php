...
class Jetpack_Force_2FA {
	...
	public function __construct() {
		_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Force_2FA::__construct' );
	}
	...
	public function plugins_loaded() {
		_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Force_2FA::plugins_loaded' );
	}
	...
	public function admin_notice() {
		_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Force_2FA::admin_notice' );
	}
	...
	public function jetpack_set_two_step( $user_data ) {
		_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Force_2FA::jetpack_set_two_step' );
	}
}
