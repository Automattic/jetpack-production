 ...
 *
 * @deprecated 13.5-a.2 Use Automattic\Jetpack\Connection\Manager\SSO instead.
 *
...
if ( ! class_exists( 'Jetpack_SSO_Notices' ) ) :
	...
	class Jetpack_SSO_Notices {
		...
		public static function error_msg_enable_two_step( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::error_msg_enable_two_step' );
		...
		public static function error_msg_email_already_exists( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::error_msg_email_already_exists' );
		...
		public static function error_msg_identity_crisis( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::error_msg_identity_crisis' );
		...
		public static function error_invalid_response_data( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::error_invalid_response_data' );
		...
		public static function error_unable_to_create_user( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::error_unable_to_create_user' );
		...
		public static function disable_default_login_form( $user ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::disable_default_login_form' );
		...
		public static function msg_login_by_jetpack( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::msg_login_by_jetpack' );
		...
		public static function get_sso_required_message() {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::get_sso_required_message' );
		...
		public static function cant_find_user( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::cant_find_user' );
		...
		public static function sso_not_allowed_in_staging( $message ) {
			_deprecated_function( __METHOD__, 'jetpack-13.5-a.2', 'Automattic\\Jetpack\\Connection\\Manager\\SSO\\Notices::sso_not_allowed_in_staging' );
