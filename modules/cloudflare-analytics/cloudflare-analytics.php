 ...
 *
 * @deprecated 13.4-a.8 Moved to mu-wpcom.
 *
...
_deprecated_file( __FILE__, 'jetpack-13.4-a.8' );
...
function insert_tracking_id() {
	_deprecated_function( __FUNCTION__, 'jetpack-13.4-a.8', 'Automattic\\Jetpack\\Jetpack_Mu_Wpcom\\Cloudflare_Analytics\\insert_tracking_id' );
}
