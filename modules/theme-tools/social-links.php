...
if ( ! class_exists( 'Social_Links' ) ) {
	 ...
	 *
	 * @deprecated 13.8-a.2 Moved to Classic Theme Helper package.
	 */
	class Social_Links {
		...
		public function __construct() {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->__construct' );
			// @phan-suppress-next-line PhanNoopNew
			new \Automattic\Jetpack\Classic_Theme_Helper\Social_Links();
		}
		...
		public function admin_setup() {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->admin_setup' );
		...
		public function check_links() {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->check_links' );
			$social_links_instance = new \Automattic\Jetpack\Classic_Theme_Helper\Social_Links();
		...
		public function customize_register( $wp_customize ) {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->customize_register' );
			$social_links_instance = new \Automattic\Jetpack\Classic_Theme_Helper\Social_Links();
		...
		public function sanitize_link( $option ) {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->sanitize_link' );
		...
		public function has_social_links() {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->has_social_links' );
		...
		public function get_social_links() {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->get_social_links' );
		...
		public function get_social_link_filter( $link ) {
			_deprecated_function( __METHOD__, '13.8-a.2', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Social_Links->get_social_link_filter' );
