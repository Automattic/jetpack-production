...
if ( ! class_exists( 'Featured_Content' ) && isset( $GLOBALS['pagenow'] ) && 'plugins.php' !== $GLOBALS['pagenow'] ) {
	 ...
	 *
	 * @deprecated 13.6-a.0 Moved to Classic Theme Helper package.
	 */
	class Featured_Content {
		...
		public static function setup() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content::setup' );
		...
		public static function init() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\init' );
		...
		public static function wp_loaded() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\wp_loaded' );
		...
		public static function get_featured_posts() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\get_featured_posts' );
		...
		public static function get_featured_post_ids() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\get_featured_post_ids' );
		...
		public static function delete_transient() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\delete_transient' );
		...
		public static function flush_post_tag_cache( $prev, $opts ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\flush_post_tag_cache' );
		...
		public static function pre_get_posts( $query ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\pre_get_posts' );
		...
		public static function delete_post_tag( $tag_id ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\delete_post_tag' );
		...
		public static function hide_featured_term( $terms, $taxonomies, $args ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\hide_featured_term' );
		...
		public static function hide_the_featured_term( $terms, $id, $taxonomy ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\hide_the_featured_term' );
		...
		public static function register_setting() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\register_setting' );
		...
		public static function customize_register( $wp_customize ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\customize_register' );
		...
		public static function enqueue_scripts() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\enqueue_scripts' );
		...
		public static function render_form() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\render_form' );
		...
		public static function get_setting( $key = 'all' ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\get_setting' );
		...
		public static function validate_settings( $input ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\validate_settings' );
		...
		public static function switch_theme() {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\switch_theme' );
		...
		public static function jetpack_update_featured_content_for_split_terms( $old_term_id, $new_term_id, $term_taxonomy_id, $taxonomy ) {
			_deprecated_function( __METHOD__, 'jetpack-13.6-a.0', 'Automattic\\Jetpack\\Classic_Theme_Helper\\Featured_Content\\jetpack_update_featured_content_for_split_terms' );
