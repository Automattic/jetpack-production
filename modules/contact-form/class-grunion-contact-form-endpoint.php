...
if ( class_exists( 'WP_REST_Posts_Controller' ) ) {
	 ...
	 *
	 * @deprecated 13.3-a.0 Use Automattic\Jetpack\Forms\ContactForm\Contact_Form_Endpoint
	 */
	class Grunion_Contact_Form_Endpoint extends WP_REST_Posts_Controller {
		 ...
		 *
		 * @deprecated 13.3-a.0 Use Automattic\Jetpack\Forms\ContactForm\Contact_Form_Endpoint->get_items_permissions_check
		 * @param  WP_REST_Request $request Full details about the request.
		 * @return WP_Error|boolean
		 */
		public function get_items_permissions_check( $request ) {
			_deprecated_function( __METHOD__, 'jetpack-13.3-a.0', 'Automattic\Jetpack\Forms\ContactForm\Contact_Form_Endpoint->get_items_permissions_check' );
		 ...
		 *
		 * @deprecated 13.3-a.0 Use Automattic\Jetpack\Forms\ContactForm\Contact_Form_Endpoint->get_item_permissions_check
		 * @param  WP_REST_Request $request Full details about the request.
		 * @return WP_Error|boolean
		 */
		public function get_item_permissions_check( $request ) {
			_deprecated_function( __METHOD__, 'jetpack-13.3-a.0', 'Automattic\Jetpack\Forms\ContactForm\Contact_Form_Endpoint->get_item_permissions_check' );
