...
class Jetpack_VideoPress {
	...
	public function enqueue_jwt_token_bridge() {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Jwt_Token_Bridge::enqueue_jwt_token_bridge' );
	...
	public function delete_video_wpcom( $delete, $post ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::delete_video_wpcom' );
	...
	public function maybe_get_attached_url_for_videopress( $default, $post_id ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::maybe_get_attached_url_for_videopress' );
	...
	public function add_video_upload_mimes( $existing_mimes = array() ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::add_video_upload_mimes' );
	...
	public function filter_video_mimes( $value ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::filter_video_mimes' );
	...
	public function wp_mime_type_icon( $icon, $mime, $post_id ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::wp_mime_type_icon' );
	...
	public function add_videopress_extenstion( $extensions ) {
		_deprecated_function( __METHOD__, 'jetpack-11.3-a.4', 'Automattic\Jetpack\VideoPress\Attachment_Handler::add_videopress_extenstion' );
