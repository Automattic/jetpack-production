...
### 11.8.4 - 2023-02-15
#### Bug fixes
- Blaze: prevent error on frontend-loaded Gutenberg, and bail early if Jetpack is not connected.
- WAF: fix PHP fatal when the jetpack-waf directory has been deleted from the wp-content folder.
