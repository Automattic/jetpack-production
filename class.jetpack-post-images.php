 ...
 *
 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images instead.
...
class Jetpack_PostImages {
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_slideshow() instead.
	 *
	...
	public static function from_slideshow( $post_id, $width = 200, $height = 200 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_slideshow' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::filter_gallery_urls() instead.
	 *
	 * @param array $galleries Galleries.
	 * @return array $filtered_galleries
	 */
	public static function filter_gallery_urls( $galleries ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::filter_gallery_urls' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_gallery() instead.
	 *
	 * @param int $post_id Post ID.
	...
	public static function from_gallery( $post_id, $width = 200, $height = 200 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_gallery' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_attachment() instead.
	 *
	...
	public static function from_attachment( $post_id, $width = 200, $height = 200 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_attachment' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_thumbnail() instead.
	 *
	 * @param  int $post_id The post ID to check.
	 * @param  int $width Image width.
	 * @param  int $height Image height.
	...
	public static function from_thumbnail( $post_id, $width = 200, $height = 200 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_thumbnail' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_blocks() instead.
	 *
	...
	public static function from_blocks( $html_or_id, $width = 200, $height = 200 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_blocks' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_html() instead.
	 *
	 * @param mixed $html_or_id The HTML string to parse for images, or a post id.
	 * @param int   $width      Minimum Image width.
	 * @param int   $height     Minimum Image height.
	 ...
	 * Data from blavatar.
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_blavatar() instead.
	 *
	 * @param    int $post_id The post ID to check.
	 * @param    int $size Size.
	 * @return array containing details of the image, or empty array if none.
	...
	public static function from_blavatar( $post_id, $size = 96 ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_blavatar' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::from_gravatar() instead.
	 *
	 * @param int          $post_id The post ID to check.
	...
	public static function from_gravatar( $post_id, $size = 96, $default = false ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::from_gravatar' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_image() instead.
	 *
	 * @param int   $post_id Post ID.
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_images() instead.
	 *
	 * @param  int   $post_id Post ID.
	...
	public static function get_images( $post_id, $args = array() ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::get_images' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::generate_cropped_srcset() instead.
	 *
	...
	public static function generate_cropped_srcset( $image, $base_width, $base_height, $use_widths = false ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::generate_cropped_srcset' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::fit_image_url() instead.
	 *
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_post_html() instead.
	 *
	 * @param mixed $html_or_id The HTML string to parse for images, or a post id.
	 *
	...
	public static function get_post_html( $html_or_id ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::get_post_html' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_attachment_data() instead.
	 *
	...
	public static function get_attachment_data( $attachment_id, $post_url, $width, $height ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::get_attachment_data' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_alt_text() instead.
	 *
	...
	public static function get_alt_text( $attachment_id ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::get_alt_text' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::determine_thumbnail_size_for_photon() instead.
	 *
	...
	public static function determine_thumbnail_size_for_photon( $width, $height ) {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::determine_thumbnail_size_for_photon' );
	 ...
	 *
	 * @deprecated 15.7-a.0 Use Automattic\Jetpack\Post_Media\Images::get_max_thumbnail_dimension() instead.
	 *
	 * @return int The maximum dimension for a thumbnail image.
	 */
	public static function get_max_thumbnail_dimension() {
		_deprecated_function( __METHOD__, '15.7-a.0', 'Automattic\Jetpack\Post_Media\Images::get_max_thumbnail_dimension' );
