 ...
 * @deprecated 12.2-a.2 Use Automattic\Jetpack\Image_CDN\Image_CDN instead.
 */
...
class Jetpack_Photon {
	...
	public function __call( $name, $arguments ) {
		if ( method_exists( Image_CDN::class, $name ) ) {
			_deprecated_function( __CLASS__ . '::' . esc_html( $name ), 'jetpack-12.2-a.2', 'Automattic\Jetpack\Image_CDN\Image_CDN::' . esc_html( $name ) );
