...
<p><?php echo esc_html( $message ); ?></p>
	...
	public static function do_version_bump( $version, $old_version ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable -- Signature preserved for the deprecation shim.
		_deprecated_function( __METHOD__, 'jetpack-16.2-a.0' );
	}
	...
	public static function get_stat_data( $encode = true, $extended = true ) {
		_deprecated_function( __METHOD__, 'jetpack-16.2-a.0', 'Automattic\\Jetpack\\Heartbeat::generate_stats_array' );
...
<div id="message" class="jetpack-message jetpack-err">
	...
	public static function check_identity_crisis() {
		_deprecated_function( __METHOD__, 'jetpack-16.2-a.0', 'Automattic\\Jetpack\\Identity_Crisis::check_identity_crisis' );
